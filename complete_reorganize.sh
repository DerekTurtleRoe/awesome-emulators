...
# Complete reorganization script to create manufacturer-based README
# This creates the final reorganized file

echo "Creating complete reorganized README.md..."

# Create the new file with header and legend
...
# Now append Nintendo content from original file
echo "Adding Nintendo sections..."
sed -n '354,866p' README_original.md >> README_final.md

# Add Sony sections (consoles)
echo "Adding Sony sections..."
sed -n '259,352p' README_original.md >> README_final.md

# Add Sony handhelds (PSP, PocketStation, Vita)
sed -n '1053,1084p' README_original.md >> README_final.md

# Add Sega sections
echo "Adding Sega sections..."
sed -n '564,690p' README_original.md >> README_final.md

# Add Sega Game Gear (from handheld section)
sed -n '1044,1050p' README_original.md >> README_final.md

# Add Microsoft sections
echo "Adding Microsoft sections..."
sed -n '651,689p' README_original.md >> README_final.md

# Add Atari sections (consoles)
sed -n '193,250p' README_original.md >> README_final.md

# Add Atari Lynx (from handhelds)
sed -n '1037,1042p' README_original.md >> README_final.md

# Add Atari computers
sed -n '1368,1386p' README_original.md >> README_final.md

echo "Nintendo, Sony, Sega, Microsoft, and Atari sections added."
echo "README_final.md created with reorganized manufacturer sections."